...
//Particles + Animtated Url
import ParticlesOptions from './components/particlesOptions/ParticlesOptions'; 
import AnimatedUrl from './components/animatedurl/AnimatedUrl';

//eslint-disable-next-line
const magicUrl = AnimatedUrl;
...
class App extends Component {
  ...
  onButtonSubmit = () => {
    ...
    fetch('https://safe-retreat-97944.herokuapp.com/imageurl', {
      method: 'post',
      ...
      .then(response => {
        if (response) {
          fetch('https://safe-retreat-97944.herokuapp.com/image', {
            method: 'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
